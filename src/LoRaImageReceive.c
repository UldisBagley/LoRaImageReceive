...
//     *width = 32;
//     *height = 24;
//     *channels = 3; //3 channels is all colours, 1 is greyscale I think?

//     unsigned char *img; //unsigned char
    
//     img = stbi_load(rx->buf, width, height, channels, 0);

//     printf("Image loaded from buffer\n");

//     modem->tx.data.size = 0;//Payload len. 0 for unlimited
...
//     stbi_write_jpg("/home/ubagley18/Documents/projects/LoRaImageTransfer/src/sky2.jpg", *width, *height, *channels, img, 100);
